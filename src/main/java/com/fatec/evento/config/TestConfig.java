...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Comum c1 = new Comum(null, "Caique", "caique@gmail.com", Md5.criptografar("comum1!@#"), "143218761", "08111100");
		Comum c2 = new Comum(null, "Gustavo", "gustavo@gmail.com", Md5.criptografar("comum2!@#"), "243218762", "08222200");
		...
		Artista a1 = new Artista(null, "Victor Neves", "victor@gmail.com", Md5.criptografar("artista1!@#"), img1, "91119911", "09111100", "artista individual 1 com sua descrição", false);
		Artista a2 = new Artista(null, "Raizer Varela", "raizer@gmail.com", Md5.criptografar("artista2!@#"), img2, "92229922", "09222200", "artistas - grupo 2 com sua descrição", true);
		...
		Espaco e1 = new Espaco(null, "Teatro blala", "espaco1@gmail.com", Md5.criptografar("espaco1!@#"), img3, "991191119", "Rua A, 01 - São Paulo - SP", "espaco 1 acessível público com sua desrição", true, true);
		Espaco e2 = new Espaco(null, "Museu uma boa", "espaco2@gmail.com", Md5.criptografar("espaco2!@#"), img4, "992292229", "Rua B, 02 - São Paulo - SP", "espaco 2 sem acessibilidade privado com sua desrição", false, false);
